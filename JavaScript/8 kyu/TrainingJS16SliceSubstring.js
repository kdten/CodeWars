...
// //function cutIt(arr){
//     let lengthOfShortestString = 500
//     arr.forEach((stringInArray) => {
//       stringInArray.length < lengthOfShortestString
//       ? lengthOfShortestString = stringInArray.length
//       : null
//     })
//     arr = arr.map((x) => x.slice(0, lengthOfShortestString))
//     return arr
//   }
